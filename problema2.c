...
int main() {
    ...
    do {
        ...
        printf("4. Encontrar el valor más pequeño del árbol\n");
        printf("5. Encontrar el valor más grande del árbol\n");
        printf("6. Determinar la altura del árbol\n");
        printf("7. Imprimir el árbol en Pre-orden\n");
        printf("8. Imprimir el árbol en In-orden\n");
        printf("9. Imprimir el árbol en Post-orden\n");
        printf("10. Eliminar todo el árbol\n");
        printf("0. Salir\n");
